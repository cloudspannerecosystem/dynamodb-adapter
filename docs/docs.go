...
var doc = `{
    ...
    "paths": {
        "/transactWriteItems/": {
            "post": {
                "description": "TransactWriteItems",
                "produces": [
                    "application/json"
                ],
                "summary": "TransactWriteItems",
                "operationId": "transact-write-items",
                "parameters": [
                    {
                        "description": "Please add request body of type models.TransactWriteItem",
                        "name": "requestBody",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.TransactWriteItem"
                        }
                    }
                ],
                "responses": {
